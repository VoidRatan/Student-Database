...
def login():
    ...
    elif usernameEntry.get()=='Prasun' and passwordEntry.get()=='1234':
...
window.title('Login to BVPCOEP Student Database Management System')
...
backgroundImage=ImageTk.PhotoImage(file='PLgQbl.jpg')
